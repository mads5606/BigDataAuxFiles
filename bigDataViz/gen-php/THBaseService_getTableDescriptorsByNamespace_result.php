...
class THBaseService_getTableDescriptorsByNamespace_result
{
    ...
    {
        return 'THBaseService_getTableDescriptorsByNamespace_result';
    }
    ...
    {
        $xfer = 0;
        $xfer += $output->writeStructBegin('THBaseService_getTableDescriptorsByNamespace_result');
