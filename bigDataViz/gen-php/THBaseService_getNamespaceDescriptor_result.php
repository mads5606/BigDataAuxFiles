...
class THBaseService_getNamespaceDescriptor_result
{
    ...
    {
        return 'THBaseService_getNamespaceDescriptor_result';
    }
            ...
            switch ($fid) {
                case 0:
                    if ($ftype == TType::STRUCT) {
                        $this->success = new \TNamespaceDescriptor();
    ...
    {
        $xfer = 0;
        $xfer += $output->writeStructBegin('THBaseService_getNamespaceDescriptor_result');
